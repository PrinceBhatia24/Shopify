			...
			<div class="col-md-6 login-form">
				<div class="login_form_in">
					...
					<form action="SetNewPassword" method="POST">
						...
						<div class="form-group">
							<button type="submit" class="btn btn-primaryy btn-lg btn-block">Reset
								Password</button>
						</div>
